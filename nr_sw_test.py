...
def show_prediction_false(dcm_filename, windows_num, coord, predictions_list, labels_list, forge_probabilities_list):
    ...
    # dcm = pydicom.read_file('/home/manager/dataset/ComputerVision/Medical_Image/ctgan_my_generate/' + dcm_filename)
    ...
    #     File.write(log_str.format(dcm_filename, gt_label, predict_label, len(negative_list) / windows_num,
    #                               result_dict['TP'], result_dict['TN'], result_dict['FP'], result_dict['FN'],
...
if __name__ == '__main__':
    ...
    checkpointDir = r'/home/manager/hxx/PyWorkspace/GAN_small_forge_detection/checkpoint'
    total_ct_log_path = r'/home/manager/hxx/PyWorkspace/GAN_small_forge_detection/step_accuracy/sw_test_total.txt'
    filename_log_path = r'/home/manager/hxx/PyWorkspace/GAN_small_forge_detection/step_accuracy/filename_log.txt'
    train_detail_str = '\n===== new log =====\n'
    ...
    # numSamplesPerEpoch = windows_num * 2000
